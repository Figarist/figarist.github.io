    ...
    fetch(indexUrl)
      ...
      .then(function (data) {
        ...
        data.forEach(function (item) {
          // Pre-compute tagsHtml during initialization (runs once per item)
          // Avoids redundant string allocations and parsing in the high-frequency executeSearch render loop
